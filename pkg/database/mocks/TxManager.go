...
func (_m *TxManager) BeginTx(ctx context.Context) (context.Context, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager) Commit(ctx context.Context) (context.Context, error) {
	ret := _m.Called(ctx)
...
func (_m *TxManager) Rollback(ctx context.Context) (context.Context, error) {
	ret := _m.Called(ctx)
